...
legend_labels_with_percentages = [
    ...
    for category, count in zip(labels, sizes)
]

# Plotting the pie chart without percentages on the chart
plt.figure(figsize=(5, 5))  # Adjust the size of the pie chart
wedges, texts = plt.pie(
    sizes, 
    labels=None,  # Hide labels on the pie chart itself
    startangle=90, 
...
# Adding the custom legend with counts and percentages
plt.legend(
    wedges, 
    legend_labels_with_percentages, 
    title="Categories", 
