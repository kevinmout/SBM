...
Before we look at the results, let's revisit the research question: "*How are the 6 different revenue models as proposed by @djaruma2023 correlate to the success of an app?*". Where we identify 6 different revenue models, described in this section as (revenue) levels. For reference see table [@tbl-levels].
...
To find the success of an app, we have established in the "Literature Review" subsection **\[verwijzing\]**, that it can be measured by:

**Geen opsomming maar lopend verhaal. De resultaten zijn op basis van deze succes factoren.**
